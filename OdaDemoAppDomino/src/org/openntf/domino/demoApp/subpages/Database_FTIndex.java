...
public class Database_FTIndex extends BaseSubPage {
	...
	public void loadContent() {
		final Label label1 = new Label("A number of enums related to Full Text Indexing have been added to OpenNTF Domino API.");
		final Button button1 = new Button("FTIndexOption");
		...
		final Button button2 = new Button("FTIndexFrequency");
		...
		final Button button3 = new Button("FTSearchOption");
		...
		final Button button4 = new Button("FTSortOption");
		...
		final Button button5 = new Button("FTDomainSearchOption");
		...
		final Button button6 = new Button("FTDomainSortOption");
		...
		addComponents(label1, new Html_Separator(SeparatorType.NEW_LINE), button1, button2, button3, button4, button5, button6, new Html_Separator(SeparatorType.NEW_LINE),
				getSubContentPanel());
	}
	...
	private void setFtIndexLayout() {
		...
		final Label label1 = new Label("FTIndexOption");
		label1.setStyleName(ValoTheme.LABEL_H3);
		final Label label2 = new Label("Used by " + FactoryUtils.addCodeString("Database.createFTIndex()")
		...
		for (final FTIndexOption elem : FTIndexOption.values()) {
			final Label label3 = new Label("<li>" + elem + " - " + elem.getValue() + "</li>", ContentMode.HTML);
			ftIndexLayout.addComponent(label3);
		}
		final Label label4 = new Label("</ul>", ContentMode.HTML);
	...
	private void setFtFrequencyLayout() {
		...
		final Label label1 = new Label("FTIndexFrequency");
		label1.setStyleName(ValoTheme.LABEL_H3);
		final Label label2 = new Label("Used by " + FactoryUtils.addCodeString("Database.setFTIndexFrequency()")
		...
		for (final FTIndexFrequency elem : FTIndexFrequency.values()) {
			final Label label3 = new Label("<li>" + elem + " - " + elem.getValue() + "</li>", ContentMode.HTML);
	...
	private void setFtSearchOptionLayout() {
		...
		final Label label1 = new Label("FTSearchOption");
		label1.setStyleName(ValoTheme.LABEL_H3);
		final Label label2 = new Label("Used by " + FactoryUtils.addCodeString("Database.FTSearch()")
				+ " methods. Normally those methods takes an integer, but the overloaded methods allows developers to use an enum. " + "Options are:<ul>");
		label2.setContentMode(ContentMode.HTML);
		ftSearchOptionLayout.addComponents(label1, label2);
		for (final FTSearchOption elem : FTSearchOption.values()) {
			final Label label3 = new Label("<li>" + elem + " - " + elem.getValue() + "</li>", ContentMode.HTML);
	...
	private void setFtSortOptionLayout() {
		...
		final Label label1 = new Label("FTSortOption");
		label1.setStyleName(ValoTheme.LABEL_H3);
		final Label label2 = new Label("Used by " + FactoryUtils.addCodeString("Database.FTSearch()")
				+ " methods. Normally those methods takes an integer, but the overloaded methods allows developers to use an enum. " + "Options are:<ul>");
		label2.setContentMode(ContentMode.HTML);
		ftSortOptionLayout.addComponents(label1, label2);
		for (final FTSortOption elem : FTSortOption.values()) {
			final Label label3 = new Label("<li>" + elem + " - " + elem.getValue() + "</li>", ContentMode.HTML);
	...
	private void setFtDomainSearchOptionLayout() {
		...
		final Label label1 = new Label("FTDomainSearchOption");
		label1.setStyleName(ValoTheme.LABEL_H3);
		final Label label2 = new Label("Used by " + FactoryUtils.addCodeString("Database.FTDomainSearch()")
				+ " methods. Normally those methods takes an integer, but the overloaded methods allows developers to use an enum. " + "There are more options available than "
				+ FactoryUtils.addCodeString("Database.FTSearchOption") + ".Options are:<ul>");
		label2.setContentMode(ContentMode.HTML);
		ftDomainSearchOptionLayout.addComponents(label1, label2);
		for (final FTDomainSearchOption elem : FTDomainSearchOption.values()) {
			final Label label3 = new Label("<li>" + elem + " - " + elem.getValue() + "</li>", ContentMode.HTML);
	...
	private void setFtDomainSortOptionLayout() {
		...
		final Label label1 = new Label("FTDomainSortOption");
		label1.setStyleName(ValoTheme.LABEL_H3);
		final Label label2 = new Label("Used by " + FactoryUtils.addCodeString("Database.FTDomainSearch()")
				+ " methods. Normally those methods takes an integer, but the overloaded methods allows developers to use an enum. " + "There are fewer options than "
				+ FactoryUtils.addCodeString("Database.FTSortOption") + ". Options are:<ul>");
		label2.setContentMode(ContentMode.HTML);
		ftDomainSortOptionLayout.addComponents(label1, label2);
		for (final FTDomainSortOption elem : FTDomainSortOption.values()) {
			final Label label3 = new Label("<li>" + elem + " - " + elem.getValue() + "</li>", ContentMode.HTML);
