...
public class Database_Summary extends BaseSubPage {
	...
	public void loadContent() {
		final Database db1 = FactoryUtils.getDemoDatabase();
		final Label label1 = new Label("Database details are: " + db1.getServer() + ", " + db1.getFilePath() + "<br/>ApiPath is: " + db1.getApiPath() + "<br/>MetaReplicaId is: "
				+ db1.getMetaReplicaID());
